...
- Persists `mode`, `serverHost`, `serverAddress`, and `autoStart` to
  `~/.config/quickshell/input-leap.conf` as plain JSON.
...
- Server: `input-leaps --no-daemon [--address <serverAddress>]`
